  ...
  if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDb367fJu9uomayQras6aDdyji9LjVUXfE",
        appId: "1:178809815397:android:46accb9ab01b832246218c",
        messagingSenderId: "178809815397",
        projectId: "oydeal-dcodax-6c694",
      ),
    );
  }else {
    await Firebase.initializeApp();
